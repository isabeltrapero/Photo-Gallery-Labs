...
const votesAPI_auto = {
    ...
    */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/votes`,requestOptions);
        return response.data;
    },

    /**
    * Gets an entry from 'votes' by its primary key
    */
    getById: async function(voteId) {
        let response = await axios.get(`${BASE_URL}/votes/${voteId}`,requestOptions);
        return response.data[0];
    },

    /**
    * Creates a new entry in 'votes'
    */
    create: async function(formData, ) {
        let response = await axios.post(`${BASE_URL}/votes`,formData, requestOptions);
        return response.data;
    },

    /**
    * Updates an existing entry in 'votes' by its primary key
    */
    update: async function(formData, voteId) {
        let response = await axios.put(`${BASE_URL}/votes/${voteId}`,formData, requestOptions);
        return response.data;
    },

    /**
    * Deletes an existing entry in 'votes' by its primary key
    */
